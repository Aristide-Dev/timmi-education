...
import { type BreadcrumbItem, type Matiere, type Niveau } from '@/types';
...
export default function Create({ matieres, niveaux }: Props) {
  ...
  const form = useForm({
    ...
    telephone: '',
    bio: '',
    matieres: [] as Array<{ matiere_id: number; niveau_id: number | null }>,
  });
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Créez un nouveau compte professeur avec ses informations de localisation
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3 justify-end">
            ...
            >
              ...
              {isSaving ? 'Création...' : 'Créer le professeur'}
            </Button>
          </div>
        </form>
      </div>
